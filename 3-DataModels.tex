...
\begin{table}[h!]
    ...
    %\hline
    Sierra Miwok &  &  & Polysynthetic & Endangered \\ 
...
[tau] (Nabesna, Tabesna) belongs to the Alaskan sub-group of the Northern Dene (Athabaskan) family. Although it is one of the official languages of Alaska and has been taught in a Canadian school, it is critically endangered, with barely 50 adult speakers in the eastern interior of Alaska (USA) and the Yukon Territory (Canada)  \citep{eberhard_ethnologue:2020}. Its complex morphology features non-continuous lexical, derivational, and inflectional prefixes on verbs \citep{lovick_computational_2018}. The corpus was collected in 2006-2019 in Alaska; most speakers represented the Tetlin and Northway dialects. 
%Two annotators did most of the interlinearization with small contributions from 2 or 3 others. 
The primary data (recordings, transcripts) is archived at the Alaska Native Language Archive.\footnote{\url{https://www.uaf.edu/anla/}}.
