...
\section{POS Tagging in Computational Morphology}
...
Work in computational morphology for low-resource languages often make the assumption that other interlinear information is available and POS tags are a frequent example of this assumption. For example, 
