...
\begin{table}
    ...
    \begin{tabular}{l|cc|cc}
        ...
        Upper Tanana &  &  &  &  \\
    \end{tabular}
    \caption[F$_1$-score Differences of Feature-based Models minus Deep Learning]{The differences between the CRF or CRF+SVM models and the Transformer. Positive scores means the feature-based model outperformed the Transformer.}
