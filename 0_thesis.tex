...
This dissertation explores how to train supervised machine learning systems for morphological analysis on limited data and how these systems might be integrated into the documentation and description of endangered languages. Unlike previous studies which have mostly experimented with one or two languages, this study applies machine learning models to nine languages. 
...
These results are indicators that Natural Language Processing (NLP) systems could be successfully integrated into the documentary and descriptive workflow and that NLP may benefit from documentary linguistic data even when only limited annotated data exists for a language.
